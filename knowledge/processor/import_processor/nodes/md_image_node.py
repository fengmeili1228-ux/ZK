...
class MdImageNode(BaseNode):
    ...
    def __init__(self):
        ...
        self.image_scanner = _ImageScanner(self.config,self.logger)
...
if __name__ == '__main__':
    state = {
        "md_path":r"D:\LearningMaterials\Data\practice\py-demo\shopkeeper-brain-BJ0108\knowledge\processor\import_processor\output_dir\万用表RS-12的使用\万用表RS-12的使用.md"
